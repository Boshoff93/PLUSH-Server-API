...
func likePost(w http.ResponseWriter, r *http.Request){
  ...
  go func() {
    ...
    if err := session.Query("SELECT post_id, user_id, like, dislike FROM posts_likes_dislikes WHERE post_id = ? AND user_id= ?",
        ...
        posts_likes_dislikes = getPosts_Likes_Dislikes(session, finished, posts_likes_dislikes, post_user_id)
...
func getPosts_Likes_Dislikes(session *gocql.Session, finished chan bool, posts_likes_dislikes Posts_Likes_Dislikes, post_user_id Post_User_Id) Posts_Likes_Dislikes {
